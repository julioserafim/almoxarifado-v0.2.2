...
$.extend( true, DataTable.defaults, {
	...
	dom:
		...
		"<'row card-action no-margin center-align'<'col s12 m12 l12 no-padding' p><'col s12 m12 l12 no-padding' i>>",
	renderer: 'bootstrap',
	oLanguage: {
		oPaginate: {
...
DataTable.ext.renderer.pageButton.bootstrap = function ( settings, host, idx, buttons, page, pages ) {
	...
	attach(
		$(host).empty().html('<ul class="pagination center"/>').children('ul'),
		buttons
	);
